...
1. **Подготовка (POST /clone):**
   - Важно чтобы названия совпадли с названими проектов в senrty или glitchtip
   - Для клонировния по ssh надо сгенерированый ключ контйнера дать пользователю с доступами к проектам для клонирования
...
**Как подлючить трекер:** См. [TRACKER.md](TRACKER.md)
## 🐳 Docker Deployment
